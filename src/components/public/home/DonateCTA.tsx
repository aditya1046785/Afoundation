...
export function DonateCTA({ settings }: DonateCTAProps) {
    ...
    return (
        <motion.section
            ...
            className="py-16 md:py-20 lg:py-24 relative overflow-hidden bg-slate-900"
        >
            ...
            <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="font-serif italic text-amber-500 text-lg tracking-wide mb-3">
                        {eyebrow}
                    </p>
                    <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight leading-tight">
                        {heading}
                    </h2>
                    <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto font-light leading-relaxed">
                        {subtext}
                    </p>
                    ...
                    <Link href="/donate">
                        <Button className="bg-amber-500 hover:bg-amber-400 text-slate-900 rounded-full px-10 py-5 text-lg md:text-xl font-bold transition-all duration-300 hover:scale-102 group border-none shadow-[0_10px_40px_-18px_rgba(245,158,11,0.28)]">
                    ...
                    <p className="mt-6 text-sm text-slate-400 tracking-wide font-light">
                        {trustText}
                    </p>
                </div>
            </div>

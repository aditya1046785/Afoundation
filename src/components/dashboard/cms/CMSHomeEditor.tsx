...
export function CMSHomeEditor({ settings }: Props) {
    ...
    const heroKeys = ["hero_heading", "hero_subheading", "hero_image", "hero_cta1_text", "hero_cta1_link", "hero_cta2_text", "hero_cta2_link"];
    ...
    const aboutKeys = ["about_brief_heading", "about_brief_text", "about_brief_image"];
    const causesKeys = ["cause1_title", "cause1_description", "cause1_icon", "cause2_title", "cause2_description", "cause2_icon", "cause3_title", "cause3_description", "cause3_icon"];
    const donateCtaKeys = ["donate_cta_heading", "donate_cta_subtext", "donate_amounts"];
    const testimonialKeys = ["testimonial1_name", "testimonial1_designation", "testimonial1_quote", "testimonial1_image", "testimonial2_name", "testimonial2_designation", "testimonial2_quote", "testimonial2_image", "testimonial3_name", "testimonial3_designation", "testimonial3_quote", "testimonial3_image"];

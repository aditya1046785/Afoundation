...
const SITE_SETTINGS: Record<string, string> = {
    ...
    // HOMEPAGE
    hero_badge_text: "The Art of Giving",
    ...
    hero_description_suffix: "Every life we touch adds a new, beautiful color to the canvas of humanity.",
    hero_image: "/hero-bg.jpg",
    hero_cta1_text: "Donate Now",
    hero_cta1_link: "/donate",
    hero_cta2_text: "Join Us",
    hero_cta2_link: "/register",
    about_brief_eyebrow: "Our Story",
    ...
    about_brief_highlights: "Registered NGO under Societies Registration Act\n80G Tax Exemption Certificate\nFully transparent fund utilization\nActive across multiple communities",
    about_brief_cta_text: "Learn More About Us",
    about_brief_cta_link: "/about",
    ...
    causes_eyebrow: "What We Do",
    causes_heading: "Our Canvas of Impact",
    causes_subtext: "We focus on three core pillars that drive sustainable change in communities, approaching every challenge with heart.",
    causes_card_cta_text: "Support This Cause",
    ...
    testimonial3_image: "",
    donate_cta_eyebrow: "Join Our Mission",
    ...
    donate_cta_button_text: "Donate Now",
    donate_cta_trust_text: "Tax benefits under 80G of Income Tax Act • Secure payment via Razorpay",
